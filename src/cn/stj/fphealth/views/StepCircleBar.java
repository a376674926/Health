...
public class StepCircleBar extends View {
	...
	public StepCircleBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public StepCircleBar(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init() {
		...
		circleStrokeWidth = DisplayUtil.dip2px(getContext(), 15);// 圆圈的线条粗细20
	...
	protected void onDraw(Canvas canvas) {
		...
		if (this.mType == 1) {// 第一个页面
			upText = getResources().getString(R.string.step_num);
			downText = getResources().getString(R.string.target_step) + max;
